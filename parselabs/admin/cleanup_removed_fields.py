...
Usage:
    parselabs admin cleanup-removed-fields --profile tiago
    parselabs admin cleanup-removed-fields --profile tiago --dry-run
    parselabs admin cleanup-removed-fields
"""
...
from parselabs.runtime import load_profile_configs
